...
export const JOURNAL_PAGES: JournalPage[] = [
  {
    ...
    alt: "The Reality Check journal page with self-reflection prompts about triggers and honesty",
    width: 1130,
    height: 1463,
  },
  {
    ...
    alt: "Quotes to Remember journal page with healing affirmations about self-worth",
    width: 1126,
    height: 1462,
  },
  {
    ...
    alt: "Keeping Receipts journal page for documenting relationship patterns and accountability",
    width: 1130,
    height: 1462,
  },
  {
    ...
    alt: "How I Can Choose Me journal page outlining personal standards and boundaries",
    width: 1128,
    height: 1458,
  },
  {
    ...
    alt: "My Personal Experiences journal page with open space for free writing and reflection",
    width: 1126,
    height: 1456,
  },
  {
    ...
    alt: "Things I Need to Remember journal page with open-lined notes space for breakthroughs and affirmations",
    width: 1126,
    height: 1458,
  },
];
